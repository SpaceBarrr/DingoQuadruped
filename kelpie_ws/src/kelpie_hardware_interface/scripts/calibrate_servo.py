...
class CalibrateServo():
    ...
    def __init__(self):
        ...
        self.ANGLES = {"fr r":0, "fr u":0, "fr l":90, "fl r":0, "fl u":0, "fl l":90, "rr r":0, "rr u":0, "rr l":90, "rl r":0, "rl u":0, "rl l":90}
        if os.path.isfile(f"{DIR_PATH}/calibrate_servo_angles.yaml"):
            ...
            self.offset = {"fr r":0, "fr u":0, "fr l":90, "fl r":0, "fl u":0, "fl l":90, "rr r":0, "rr u":0, "rr l":90, "rl r":0, "rl u":0, "rl l":90}
        self._set_start_pos()

    def _set_start_pos(self):
        self.servo_interface.physical_calibration_offsets = self._format_offset()
        self.servo_angles = np.array([[self.ANGLES["fr r"], self.ANGLES["fl r"], self.ANGLES["rr r"], self.ANGLES["rl r"]],
